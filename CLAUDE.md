...
**Current: v0.1.0 — Iterations 1-240 complete (459+ Redis commands)**
**Target: v1.0 — 100% Redis compatibility (500+ commands)**
**Roadmap: [docs/PRD.md](docs/PRD.md)**

240 iterations complete (459+ command implementations). See `docs/milestones.md` for detailed breakdown, `docs/PRD.md` for full roadmap.
...
**Current in zoltraak**: v1.21.0 — All versions through v1.21.0 migrated. See `docs/milestones.md` for full version history.
