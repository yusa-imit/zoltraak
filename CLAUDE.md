...
**Current: v0.1.0 — Iterations 1-111 complete (191+ Redis commands)**
**Target: v1.0 — 100% Redis compatibility (500+ commands)**
**Roadmap: [docs/PRD.md](docs/PRD.md)**

111 iterations complete (191+ Redis commands). See `docs/milestones.md` for detailed breakdown, `docs/PRD.md` for full roadmap.

### Known stubs (need real implementation for 1.0)

Lua scripting (EVAL/EVALSHA execute real scripts, redis.call/pcall work, sandboxing complete, timeout mechanism complete - Phase 2 80% complete), ACL (no enforcement), Cluster (single-node), SELECT (DB 0 only). All blocking commands have true polling-based semantics. SLOWLOG, MONITOR, LATENCY, MEMORY, DEBUG, SHUTDOWN, FAILOVER, ROLE have real implementations. **Phase 6 server management 100% complete** ✅
...
**Current in zoltraak**: v1.16.0 — All versions through v1.16.0 migrated. See `docs/milestones.md` for full version history.
