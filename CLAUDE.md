...
**Current in zoltraak**: v2.82.0 — All versions through v2.82.0 migrated. See `docs/milestones.md` for full version history.
**Latest available**: v2.82.0 — DONE (migrated in Iteration 406, issue #94 closed)
