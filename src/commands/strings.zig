...
pub fn executeCommand(
    ...
    const response = blk: {
        ...
        // Client connection commands
            ...
            break :blk try client_cmds.cmdClient(allocator, client_registry, client_id, subcmd_array, getClientProtocol(client_registry, client_id), &storage.blocking_queue);
        }
